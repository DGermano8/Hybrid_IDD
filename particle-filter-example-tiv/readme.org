...
** TODO Extract core computations to module

This demonstrates the main points, but should probably be abstracted
into so we can just give it some TOML and it will do the inference.
This way it will be easier to use across both the real and simulated
data.
...
** TODO Apply inference to each of Baccam patients
